...
<head>
<meta charset="utf-8" />
<title>Travelite - @yield('title')</title>
...
<!--srart theme style -->
<link href="{{asset('template/main/css/main.css')}}" rel="stylesheet" type="text/css"/>
<!-- end theme style -->
<!-- favicon links -->
<link rel="shortcut icon" type="image/ico" href="{{asset('asset/image/favicon.ico')}}" />
<link rel="icon" type="image/ico" href="{{asset('asset/image/favicon.ico')}}" />
</head>
...
<div id="travel_wrapper"> 
  ...
  <!--Header end--> 
  <!--content body start-->
  <div id="content_wrapper"> @yield('content')</div>
  <!--content body end--> 
  <!--footer start-->
      ...
      <div class="row">
        <div class="col-md-4">
          <aside class="widget widget_text"> 
			<a href="Home_01.html"><img src="{{asset('template/main/svg/Logo.svg')}}" alt="footer logo" />
			</a> 
	 ...
	 xml:space="preserve">
		...
		C93.388,284.317,84.397,275.327,84.397,264.278z"/>
          ...
          <aside class="widget payment_method">
            ...
            <a href=""><img src="{{asset('template/main/images/Payment-Images.png')}}" alt="Payment Method" /></a> </aside>
        </div>
      </div>
    </div>
  </footer>
