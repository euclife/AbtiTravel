...
@section('content')
  ...
  <!--page title Start-->
  <div class="page_title" data-stellar-background-ratio="0" data-stellar-vertical-offset="0" style="background-image:url({{ URL::asset('upload/img/'.$foto[0]->url) }});">
      <ul>
	  ...
	  <div class="container">
	   <div class="row space_100">
	     ...
	     <div class="col-lg-3 col-md-3 col-sm-12">
		   ...
		   <div class="sidebar_search_bar">
		    <form>
			 ...
			 <h4 class="widget-title">{{ $userAgent->name }}</h4>
			 <div class="widgett text_widget">
			 <p>{{ $userAgent->deskripsi }}</p>
	       </div>
		...
		<div class="top_head_bar">
		   ...
		   <h5 class="starting_text">Mulai Dari<span>Rp. {{ number_format($data->biaya) }} /</span>per orang</h5>
		    <span class="time_date"><i class="fa fa-clock-o"></i>{{ $data->hari }} hari</span>
		   <h5 class="includes_text">termasuk:</h5>
		    <!-- desc icons Start-->
			<div class="row">
		   ...
		   <div class="package_details_slider">
			<div id="package_details_slider" class="owl-carousel owl-theme">
				@foreach($foto as $fo)
			  <div class="item"><img src="{{ asset('upload/img/'.$fo->url) }}" alt="slide"></div>
			  @endforeach
			</div>
		   </div>
		     <!-- slider end -->
          ...
          <div class="booking_area_section">
			 ...
			 <form action="{{ url('book') }}" method="POST">
				...
				<label>{{ date('d, F Y', strtotime($data->tgl_keberangkatan)) }}</label>
				</div>
				
				<div class="pullleft room_select_field">
					<label>Orang</label>
					<select class="form-control selectpicker" name="orang" data-live-search="true" id="search_adults">
				...
				<input type="hidden" name="id_tour" value="{{ $data->id_tour }}">
				<div class="pullleft room_select_field"></div>
		 ...
		 <!-- package tabs start -->
		  <div class="full_width Travelite_middle_tabs" id="Travelite_middle_tabs">
		    <div class="pcg_tabs_panel">
				<ul>
					<li> <a href="#tab_search_1">Informasi Kegiatan</a></li>
					<li> <a href="#tab_search_2" class="">Detail</a></li>
				</ul>
            </div>
		                <!--  tab content start -->
			...
			@foreach($days  as $day)
			 ...
			 <div class="day_title">Hari {{ $i++ }}</div>
			 <p> {{ $day->detail }}
             </p>
			 </div>
			 @endforeach
			...
			@for($a = 1; $a<=$i;$a++)
				@foreach($hours as $hour)
					@if($hour->id_day == $a)
					 <div class="inner_content">
					 <div class="day_title">Hari {{ $a }}</div>
						<table class="table">
							<thead>
								<tr>
									<td>JAM</td>
		 ...
		 <div class="full_width package_highlight_section">
		   ...
		   <div class="row">
			 ...
			 <h5>cost includes</h5>
			 <ul>
			 <li>Round Trip economy class airfare on Air India / Jet Airways Ex Chennai / Bangalore.</li>
			 <li>03 Night accommodation at A 3* Hotel City Hub with Breakfast ON TWIN / TRIPLE SHARING BASIS.</li>
			 <li>01 Full day pass to Universal Studio in Resort World Sentosa.</li>
			 </ul>
			 </div>
			 </div>
			 ...
			 <li>Any increase in the air fare which may come into effect prior to the departure.</li>
			 <li>Any fluctuation in the rate of exchange which may come into effect prior to the departure.</li>
			 <li>Any fluctuation in the rate of exchange which may come into effect prior to the departure.</li>
			 <li>Surcharges during conferences, conventions, trade exhibitions etc</li>
			 </ul>
			 </div>
			 </div>
