       ...
       <div class="sorting_places_wrap  list_sorting_view">
         <div class="col-lg-5 col-md-5 col-sm-5 padding_none">
           <div class="thumb_wrape">
              <img src="{{ asset('upload/img/'.$dat->foto_highlit) }}" class="img-responsive" alt="list thumb">
           </div>
         </div>
         
         <div class="col-lg-7 col-md-7 col-sm-7">
           <div class="top_head_bar">
             <h4><a href="{{ url('tour/'.$dat->id_tour) }}">{{ $dat->nama_tour }}</a></h4>
             <span class="time_date"><i class="fa fa-clock-o"></i>{{ $dat->hari }} hari</span>
           </div>
           <div class="bottom_desc">
            <h5>Mulai dengan harga<span>Rp. {{ number_format($dat->biaya) }} /</span>per orang</h5>
             <!-- desc icons Start-->
            ...
            <!-- desc icons End-->
              <div>
                <a href="{{ url('tour/'.$dat->id_tour) }}" class="list_view_details btns">Rincian</a>
              </div>
           </div>
         </div>
       </div>
